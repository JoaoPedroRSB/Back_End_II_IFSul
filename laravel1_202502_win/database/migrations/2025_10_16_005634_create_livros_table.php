...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('livros', function (Blueprint $table) {
            ...
            $table->string('genero')->nullable();  // Gênero do livro
            ...
            $table->integer('numeroDePaginas')->nullable();  // Número de páginas
            $table->string('editora')->nullable();  // Editora do livro
            $table->string('imagem')->nullable();  // Caminho da imagem (opcional)
            $table->text('sinopse')->nullable();  // Sinopse do livro
            $table->decimal('preco', 8, 2);  // Preço do livro
            $table->date('lancamento')->nullable();  // Data de lançamento
